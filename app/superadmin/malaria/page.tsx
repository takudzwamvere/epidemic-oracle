...
const AIAnalysisContent = ({ aiAnalysis }: { aiAnalysis: any }) => {
  ...
  return (
    <div className="space-y-8">
      {/* National Overview */}
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border-l-4 border-blue-500 p-6 rounded-none shadow-sm">
      ...
      <div className="bg-gradient-to-r from-green-50 to-emerald-50 border-l-4 border-green-500 p-6 rounded-none shadow-sm">
        <div className="flex items-center gap-3 mb-6">
...
const RecommendationItem = ({ text, index }: { text: string; index: number }) => {
  ...
  return (
    <div className="flex items-start gap-4 p-4 bg-white rounded-none border border-green-200 hover:shadow-md transition-all duration-200">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white border border-slate-200 rounded-none p-6 shadow-sm">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-slate-900 capitalize">{disease} Outbreak Predictions</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="bg-white border border-slate-200 rounded-none p-6 shadow-sm">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center justify-center w-12 h-12 bg-blue-50 rounded-none">
      ...
      <div className="bg-white border border-slate-200 rounded-none p-6 shadow-sm">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h3 className="text-lg font-semibold text-slate-900">Select 2025 Malaria Datasets</h3>
            <p className="text-slate-600 text-sm">Choose which uploaded malaria datasets to use for predictions</p>
          </div>
        ...
        {/* Auto-Alerts Toggle */}
        <div className="flex items-center gap-3 p-4 bg-blue-50 rounded-none border border-blue-200 mb-6">
