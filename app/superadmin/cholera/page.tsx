...
const AIAnalysisContent = ({ aiAnalysis }: { aiAnalysis: any }) => {
  ...
  return (
    <div className="space-y-8">
      {/* National Overview */}
      <div className="bg-gradient-to-r from-cyan-50 to-blue-50 border-l-4 border-cyan-500 p-6 rounded-none shadow-sm">
      ...
      <div className="bg-gradient-to-r from-teal-50 to-emerald-50 border-l-4 border-teal-500 p-6 rounded-none shadow-sm">
        <div className="flex items-center gap-3 mb-6">
...
const RecommendationItem = ({ text, index }: { text: string; index: number }) => {
  ...
  return (
    <div className="flex items-start gap-4 p-4 bg-white rounded-none border border-teal-200 hover:shadow-md transition-all duration-200">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white border border-slate-200 rounded-none p-6 shadow-sm">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-slate-900 capitalize">Cholera Outbreak Predictions</h1>
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <div className="flex items-center justify-center w-12 h-12 bg-cyan-50 rounded-none">
      ...
      <div className="bg-white border border-slate-200 rounded-none p-6 shadow-sm">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h3 className="text-lg font-semibold text-slate-900">Select 2025 Cholera Datasets</h3>
            <p className="text-slate-600 text-sm">Choose which uploaded cholera datasets to use for predictions</p>
          </div>
        ...
        {/* Auto-Alerts Toggle */}
        <div className="flex items-center gap-3 p-4 bg-cyan-50 rounded-none border border-cyan-200 mb-6">
