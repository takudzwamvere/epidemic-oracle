...
const AIAnalysisContent = ({ aiAnalysis }: { aiAnalysis: any }) => {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-r from-blue-50 to-cyan-50 border-l-4 border-blue-500 p-6 rounded-lg shadow-sm">
        <div className="flex items-center gap-3 mb-6">
...
const RecommendationItem = ({ text, index }: { text: string; index: number }) => {
  ...
  return (
    <div className="flex items-start gap-4 p-4 bg-white rounded-lg border border-blue-200 hover:shadow-md transition-all duration-200">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-gray-900 capitalize">COVID-19 Outbreak Predictions</h1>
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h3 className="text-lg font-semibold text-gray-900">Select 2025 COVID-19 Datasets</h3>
            <p className="text-gray-600 text-sm">Choose which uploaded COVID-19 datasets to use for predictions</p>
          </div>
        ...
        {/* Auto-Alerts Toggle */}
        <div className="flex items-center gap-3 p-4 bg-red-50 rounded-lg border border-red-200 mb-6">
