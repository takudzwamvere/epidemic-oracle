...
export default function Home() {
  return (
    <main className="min-h-screen bg-slate-950 text-slate-100 flex flex-col justify-between selection:bg-blue-600/30">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_left,rgba(15,23,42,0.95),transparent_50%)] pointer-events-none" />
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-indigo-500/5 rounded-full blur-3xl pointer-events-none animate-pulse" style={{ animationDuration: '8s' }} />

      {/* Header */}
      <header className="relative z-10 border-b border-slate-900/60 bg-slate-950/80 backdrop-blur-md px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <Link
            href="/auth/login"
            className="px-5 py-2 rounded-lg text-sm font-semibold bg-slate-900 hover:bg-slate-800 text-white border border-slate-800 transition-all duration-200 hover:border-slate-700 hover:scale-[1.02] active:scale-[0.98]"
          >
            Sign In
          </Link>
        </div>
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 py-20 lg:py-32 flex flex-col lg:flex-row items-center gap-12 flex-1">
        <div className="flex-1 space-y-8 text-center lg:text-left">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-500/10 border border-blue-500/25 text-xs font-semibold text-blue-400 shadow-inner">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight leading-none">
            Forecast, Track, and{" "}
            <span className="bg-gradient-to-r from-blue-400 via-indigo-400 to-violet-400 bg-clip-text text-transparent animate-gradient">
              Prevent Outbreaks
            </span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
            <Link
              href="/auth/login"
              className="group w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl text-base font-bold bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white shadow-xl shadow-blue-500/15 hover:shadow-blue-500/30 transition-all duration-300 transform hover:scale-105 active:scale-[0.98]"
            >
              Access Dashboard
        ...
        <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-4 w-full max-w-2xl">
          <div className="p-6 rounded-2xl bg-slate-900/20 border border-slate-900/80 hover:border-blue-500/30 hover:bg-slate-900/50 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl hover:shadow-blue-500/5">
          ...
          <div className="p-6 rounded-2xl bg-slate-900/20 border border-slate-900/80 hover:border-indigo-500/30 hover:bg-slate-900/50 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl hover:shadow-indigo-500/5">
          ...
          <div className="p-6 rounded-2xl bg-slate-900/20 border border-slate-900/80 hover:border-violet-500/30 hover:bg-slate-900/50 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl hover:shadow-violet-500/5">
          ...
          <div className="p-6 rounded-2xl bg-slate-900/20 border border-slate-900/80 hover:border-teal-500/30 hover:bg-slate-900/50 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl hover:shadow-teal-500/5">
